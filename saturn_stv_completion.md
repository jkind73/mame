...
- [ ] **SND-04 — Qualify SCSP DSP and final mixer. [V/R]**
  ...
  - MEMS input/write ordering correction is native-WIP: remove same-instruction IWT bypass, retaining entry INPUTS for MAC/YRL/ADRL and exposing the committed value to subsequent instructions.73728 new actual-method cases and eleven mutants pass; old native66e351f7 passes631/fails128 of759 mapped programs with all previous247 intact. Rebuilt3036-program/four-profile and preceding save acceptance pending. Evidence: `saturn_pending/evidence/scsp-dsp-input/README.md`.
