...
- [ ] **DSP-01 — Resolve instruction/flag/control semantics. [P/V/R]**
  ...
  - ADD/SUB/AD2/SR corrections are integrated in ea9a7a7c as native WIP. Old8881caa1 fails118 of203 real arithmetic programs, and old ADD triggers signed-overflow UBSan. Corrected actual methods pass80,968 boundary/random/sticky/read-clear cases and seven mutants; existing DSP suites and full-TU syntax pass. Overflow-latch/32-bit ADD semantics follow convergent pinned Ymir/Mednafen with primary wording caveats documented in `saturn_pending/evidence/dsp-alu/README.md`. OR-negative-Z remains unchanged. Native positive pending; this does not complete the ALU or parent.
