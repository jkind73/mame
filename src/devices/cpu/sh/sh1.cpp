...
// Shared on-chip peripherals: two SCI channels (0x05fffec0 and 0x05fffec8),
// the ITU, the DMAC, the INTC priority registers, the UBC, the BSC, the WDT,
// the PFC and the TPC.  The addresses follow the SH-1 hardware manual register
// map, which is what the Saturn CD block firmware accesses.
void sh1_device::sh1_peripheral_map(address_map &map)
{
	map(0x05fffec0, 0x05fffec0).rw(FUNC(sh1_device::sci_smr_r<0>), FUNC(sh1_device::sci_smr_w<0>));
	map(0x05fffec1, 0x05fffec1).rw(FUNC(sh1_device::sci_brr_r<0>), FUNC(sh1_device::sci_brr_w<0>));
	map(0x05fffec2, 0x05fffec2).rw(FUNC(sh1_device::sci_scr_r<0>), FUNC(sh1_device::sci_scr_w<0>));
	map(0x05fffec3, 0x05fffec3).rw(FUNC(sh1_device::sci_tdr_r<0>), FUNC(sh1_device::sci_tdr_w<0>));
	map(0x05fffec4, 0x05fffec4).rw(FUNC(sh1_device::sci_ssr_r<0>), FUNC(sh1_device::sci_ssr_w<0>));
	map(0x05fffec5, 0x05fffec5).r(FUNC(sh1_device::sci_rdr_r<0>));
	map(0x05fffec8, 0x05fffec8).rw(FUNC(sh1_device::sci_smr_r<1>), FUNC(sh1_device::sci_smr_w<1>));
	map(0x05fffec9, 0x05fffec9).rw(FUNC(sh1_device::sci_brr_r<1>), FUNC(sh1_device::sci_brr_w<1>));
	map(0x05fffeca, 0x05fffeca).rw(FUNC(sh1_device::sci_scr_r<1>), FUNC(sh1_device::sci_scr_w<1>));
	map(0x05fffecb, 0x05fffecb).rw(FUNC(sh1_device::sci_tdr_r<1>), FUNC(sh1_device::sci_tdr_w<1>));
	map(0x05fffecc, 0x05fffecc).rw(FUNC(sh1_device::sci_ssr_r<1>), FUNC(sh1_device::sci_ssr_w<1>));
	map(0x05fffecd, 0x05fffecd).r(FUNC(sh1_device::sci_rdr_r<1>));

	map(0x05ffff00, 0x05ffff00).rw(FUNC(sh1_device::itu_tstr_r), FUNC(sh1_device::itu_tstr_w));
	map(0x05ffff01, 0x05ffff01).rw(FUNC(sh1_device::itu_tsnc_r), FUNC(sh1_device::itu_tsnc_w));
	map(0x05ffff02, 0x05ffff02).rw(FUNC(sh1_device::itu_tmdr_r), FUNC(sh1_device::itu_tmdr_w));
	map(0x05ffff03, 0x05ffff03).rw(FUNC(sh1_device::itu_tfcr_r), FUNC(sh1_device::itu_tfcr_w));
	map(0x05ffff31, 0x05ffff31).rw(FUNC(sh1_device::itu_tocr_r), FUNC(sh1_device::itu_tocr_w));

	map(0x05ffff04, 0x05ffff04).rw(FUNC(sh1_device::itu_tcr_r<0>), FUNC(sh1_device::itu_tcr_w<0>));
	map(0x05ffff05, 0x05ffff05).rw(FUNC(sh1_device::itu_tior_r<0>), FUNC(sh1_device::itu_tior_w<0>));
	map(0x05ffff06, 0x05ffff06).rw(FUNC(sh1_device::itu_tier_r<0>), FUNC(sh1_device::itu_tier_w<0>));
	map(0x05ffff07, 0x05ffff07).rw(FUNC(sh1_device::itu_tsr_r<0>), FUNC(sh1_device::itu_tsr_w<0>));
	map(0x05ffff08, 0x05ffff09).rw(FUNC(sh1_device::itu_tcnt_r<0>), FUNC(sh1_device::itu_tcnt_w<0>));
	map(0x05ffff0a, 0x05ffff0b).rw(FUNC(sh1_device::itu_gra_r<0>), FUNC(sh1_device::itu_gra_w<0>));
	map(0x05ffff0c, 0x05ffff0d).rw(FUNC(sh1_device::itu_grb_r<0>), FUNC(sh1_device::itu_grb_w<0>));

	map(0x05ffff0e, 0x05ffff0e).rw(FUNC(sh1_device::itu_tcr_r<1>), FUNC(sh1_device::itu_tcr_w<1>));
	map(0x05ffff0f, 0x05ffff0f).rw(FUNC(sh1_device::itu_tior_r<1>), FUNC(sh1_device::itu_tior_w<1>));
	map(0x05ffff10, 0x05ffff10).rw(FUNC(sh1_device::itu_tier_r<1>), FUNC(sh1_device::itu_tier_w<1>));
	map(0x05ffff11, 0x05ffff11).rw(FUNC(sh1_device::itu_tsr_r<1>), FUNC(sh1_device::itu_tsr_w<1>));
	map(0x05ffff12, 0x05ffff13).rw(FUNC(sh1_device::itu_tcnt_r<1>), FUNC(sh1_device::itu_tcnt_w<1>));
	map(0x05ffff14, 0x05ffff15).rw(FUNC(sh1_device::itu_gra_r<1>), FUNC(sh1_device::itu_gra_w<1>));
	map(0x05ffff16, 0x05ffff17).rw(FUNC(sh1_device::itu_grb_r<1>), FUNC(sh1_device::itu_grb_w<1>));

	map(0x05ffff18, 0x05ffff18).rw(FUNC(sh1_device::itu_tcr_r<2>), FUNC(sh1_device::itu_tcr_w<2>));
	map(0x05ffff19, 0x05ffff19).rw(FUNC(sh1_device::itu_tior_r<2>), FUNC(sh1_device::itu_tior_w<2>));
	map(0x05ffff1a, 0x05ffff1a).rw(FUNC(sh1_device::itu_tier_r<2>), FUNC(sh1_device::itu_tier_w<2>));
	map(0x05ffff1b, 0x05ffff1b).rw(FUNC(sh1_device::itu_tsr_r<2>), FUNC(sh1_device::itu_tsr_w<2>));
	map(0x05ffff1c, 0x05ffff1d).rw(FUNC(sh1_device::itu_tcnt_r<2>), FUNC(sh1_device::itu_tcnt_w<2>));
	map(0x05ffff1e, 0x05ffff1f).rw(FUNC(sh1_device::itu_gra_r<2>), FUNC(sh1_device::itu_gra_w<2>));
	map(0x05ffff20, 0x05ffff21).rw(FUNC(sh1_device::itu_grb_r<2>), FUNC(sh1_device::itu_grb_w<2>));

	map(0x05ffff22, 0x05ffff22).rw(FUNC(sh1_device::itu_tcr_r<3>), FUNC(sh1_device::itu_tcr_w<3>));
	map(0x05ffff23, 0x05ffff23).rw(FUNC(sh1_device::itu_tior_r<3>), FUNC(sh1_device::itu_tior_w<3>));
	map(0x05ffff24, 0x05ffff24).rw(FUNC(sh1_device::itu_tier_r<3>), FUNC(sh1_device::itu_tier_w<3>));
	map(0x05ffff25, 0x05ffff25).rw(FUNC(sh1_device::itu_tsr_r<3>), FUNC(sh1_device::itu_tsr_w<3>));
	map(0x05ffff26, 0x05ffff27).rw(FUNC(sh1_device::itu_tcnt_r<3>), FUNC(sh1_device::itu_tcnt_w<3>));
	map(0x05ffff28, 0x05ffff29).rw(FUNC(sh1_device::itu_gra_r<3>), FUNC(sh1_device::itu_gra_w<3>));
	map(0x05ffff2a, 0x05ffff2b).rw(FUNC(sh1_device::itu_grb_r<3>), FUNC(sh1_device::itu_grb_w<3>));
	map(0x05ffff2c, 0x05ffff2d).rw(FUNC(sh1_device::itu_bra_r<3>), FUNC(sh1_device::itu_bra_w<3>));
	map(0x05ffff2e, 0x05ffff2f).rw(FUNC(sh1_device::itu_brb_r<3>), FUNC(sh1_device::itu_brb_w<3>));

	map(0x05ffff32, 0x05ffff32).rw(FUNC(sh1_device::itu_tcr_r<4>), FUNC(sh1_device::itu_tcr_w<4>));
	map(0x05ffff33, 0x05ffff33).rw(FUNC(sh1_device::itu_tior_r<4>), FUNC(sh1_device::itu_tior_w<4>));
	map(0x05ffff34, 0x05ffff34).rw(FUNC(sh1_device::itu_tier_r<4>), FUNC(sh1_device::itu_tier_w<4>));
	map(0x05ffff35, 0x05ffff35).rw(FUNC(sh1_device::itu_tsr_r<4>), FUNC(sh1_device::itu_tsr_w<4>));
	map(0x05ffff36, 0x05ffff37).rw(FUNC(sh1_device::itu_tcnt_r<4>), FUNC(sh1_device::itu_tcnt_w<4>));
	map(0x05ffff38, 0x05ffff39).rw(FUNC(sh1_device::itu_gra_r<4>), FUNC(sh1_device::itu_gra_w<4>));
	map(0x05ffff3a, 0x05ffff3b).rw(FUNC(sh1_device::itu_grb_r<4>), FUNC(sh1_device::itu_grb_w<4>));
	map(0x05ffff3c, 0x05ffff3d).rw(FUNC(sh1_device::itu_bra_r<4>), FUNC(sh1_device::itu_bra_w<4>));
	map(0x05ffff3e, 0x05ffff3f).rw(FUNC(sh1_device::itu_brb_r<4>), FUNC(sh1_device::itu_brb_w<4>));

	map(0x05ffff40, 0x05ffff43).rw(FUNC(sh1_device::dma_sar_r<0>), FUNC(sh1_device::dma_sar_w<0>));
	map(0x05ffff44, 0x05ffff47).rw(FUNC(sh1_device::dma_dar_r<0>), FUNC(sh1_device::dma_dar_w<0>));
	map(0x05ffff48, 0x05ffff49).rw(FUNC(sh1_device::dmaor_r), FUNC(sh1_device::dmaor_w));
	map(0x05ffff4a, 0x05ffff4b).rw(FUNC(sh1_device::dma_tcr_r<0>), FUNC(sh1_device::dma_tcr_w<0>));
	map(0x05ffff4e, 0x05ffff4f).rw(FUNC(sh1_device::dma_chcr_r<0>), FUNC(sh1_device::dma_chcr_w<0>));

	map(0x05ffff50, 0x05ffff53).rw(FUNC(sh1_device::dma_sar_r<1>), FUNC(sh1_device::dma_sar_w<1>));
	map(0x05ffff54, 0x05ffff57).rw(FUNC(sh1_device::dma_dar_r<1>), FUNC(sh1_device::dma_dar_w<1>));
	map(0x05ffff5a, 0x05ffff5b).rw(FUNC(sh1_device::dma_tcr_r<1>), FUNC(sh1_device::dma_tcr_w<1>));
	map(0x05ffff5e, 0x05ffff5f).rw(FUNC(sh1_device::dma_chcr_r<1>), FUNC(sh1_device::dma_chcr_w<1>));

	map(0x05ffff60, 0x05ffff63).rw(FUNC(sh1_device::dma_sar_r<2>), FUNC(sh1_device::dma_sar_w<2>));
	map(0x05ffff64, 0x05ffff67).rw(FUNC(sh1_device::dma_dar_r<2>), FUNC(sh1_device::dma_dar_w<2>));
	map(0x05ffff6a, 0x05ffff6b).rw(FUNC(sh1_device::dma_tcr_r<2>), FUNC(sh1_device::dma_tcr_w<2>));
	map(0x05ffff6e, 0x05ffff6f).rw(FUNC(sh1_device::dma_chcr_r<2>), FUNC(sh1_device::dma_chcr_w<2>));

	map(0x05ffff70, 0x05ffff73).rw(FUNC(sh1_device::dma_sar_r<3>), FUNC(sh1_device::dma_sar_w<3>));
	map(0x05ffff74, 0x05ffff77).rw(FUNC(sh1_device::dma_dar_r<3>), FUNC(sh1_device::dma_dar_w<3>));
	map(0x05ffff7a, 0x05ffff7b).rw(FUNC(sh1_device::dma_tcr_r<3>), FUNC(sh1_device::dma_tcr_w<3>));
	map(0x05ffff7e, 0x05ffff7f).rw(FUNC(sh1_device::dma_chcr_r<3>), FUNC(sh1_device::dma_chcr_w<3>));

	map(0x05ffff84, 0x05ffff85).rw(FUNC(sh1_device::intc_ipra_r), FUNC(sh1_device::intc_ipra_w));
	map(0x05ffff86, 0x05ffff87).rw(FUNC(sh1_device::intc_iprb_r), FUNC(sh1_device::intc_iprb_w));
	map(0x05ffff88, 0x05ffff89).rw(FUNC(sh1_device::intc_iprc_r), FUNC(sh1_device::intc_iprc_w));
	map(0x05ffff8a, 0x05ffff8b).rw(FUNC(sh1_device::intc_iprd_r), FUNC(sh1_device::intc_iprd_w));
	map(0x05ffff8c, 0x05ffff8d).rw(FUNC(sh1_device::intc_ipre_r), FUNC(sh1_device::intc_ipre_w));
	map(0x05ffff8e, 0x05ffff8f).rw(FUNC(sh1_device::intc_icr_r), FUNC(sh1_device::intc_icr_w));

	map(0x05ffff90, 0x05ffff91).rw(FUNC(sh1_device::ubc_barh_r), FUNC(sh1_device::ubc_barh_w));
	map(0x05ffff92, 0x05ffff93).rw(FUNC(sh1_device::ubc_barl_r), FUNC(sh1_device::ubc_barl_w));
	map(0x05ffff94, 0x05ffff95).rw(FUNC(sh1_device::ubc_bamrh_r), FUNC(sh1_device::ubc_bamrh_w));
	map(0x05ffff96, 0x05ffff97).rw(FUNC(sh1_device::ubc_bamrl_r), FUNC(sh1_device::ubc_bamrl_w));
	map(0x05ffff98, 0x05ffff99).rw(FUNC(sh1_device::ubc_bbr_r), FUNC(sh1_device::ubc_bbr_w));

	map(0x05ffffa0, 0x05ffffa1).rw(FUNC(sh1_device::bsc_bcr_r), FUNC(sh1_device::bsc_bcr_w));
	map(0x05ffffa2, 0x05ffffa3).rw(FUNC(sh1_device::bsc_wcr1_r), FUNC(sh1_device::bsc_wcr1_w));
	map(0x05ffffa4, 0x05ffffa5).rw(FUNC(sh1_device::bsc_wcr2_r), FUNC(sh1_device::bsc_wcr2_w));
	map(0x05ffffa6, 0x05ffffa7).rw(FUNC(sh1_device::bsc_wcr3_r), FUNC(sh1_device::bsc_wcr3_w));
	map(0x05ffffa8, 0x05ffffa9).rw(FUNC(sh1_device::bsc_dcr_r), FUNC(sh1_device::bsc_dcr_w));
	map(0x05ffffaa, 0x05ffffab).rw(FUNC(sh1_device::bsc_pcr_r), FUNC(sh1_device::bsc_pcr_w));
	map(0x05ffffac, 0x05ffffad).rw(FUNC(sh1_device::bsc_rcr_r), FUNC(sh1_device::bsc_rcr_w));
	map(0x05ffffae, 0x05ffffaf).rw(FUNC(sh1_device::bsc_rtcsr_r), FUNC(sh1_device::bsc_rtcsr_w));
	map(0x05ffffb0, 0x05ffffb1).rw(FUNC(sh1_device::bsc_rtcnt_r), FUNC(sh1_device::bsc_rtcnt_w));
	map(0x05ffffb2, 0x05ffffb3).rw(FUNC(sh1_device::bsc_rtcor_r), FUNC(sh1_device::bsc_rtcor_w));

	map(0x05ffffb8, 0x05ffffb8).rw(FUNC(sh1_device::wdt_tcsr_r), FUNC(sh1_device::wdt_tcsr_w));
	map(0x05ffffb9, 0x05ffffb9).rw(FUNC(sh1_device::wdt_tcnt_r), FUNC(sh1_device::wdt_tcnt_w));
	map(0x05ffffba, 0x05ffffba).rw(FUNC(sh1_device::wdt_rstcsr_r), FUNC(sh1_device::wdt_rstcsr_w));

	map(0x05ffffc0, 0x05ffffc1).rw(FUNC(sh1_device::pfc_padr_r), FUNC(sh1_device::pfc_padr_w));
	map(0x05ffffc2, 0x05ffffc3).rw(FUNC(sh1_device::pfc_pbdr_r), FUNC(sh1_device::pfc_pbdr_w));
	map(0x05ffffc4, 0x05ffffc5).rw(FUNC(sh1_device::pfc_paior_r), FUNC(sh1_device::pfc_paior_w));
	map(0x05ffffc6, 0x05ffffc7).rw(FUNC(sh1_device::pfc_pbior_r), FUNC(sh1_device::pfc_pbior_w));
	map(0x05ffffc8, 0x05ffffc9).rw(FUNC(sh1_device::pfc_pacr1_r), FUNC(sh1_device::pfc_pacr1_w));
	map(0x05ffffca, 0x05ffffcb).rw(FUNC(sh1_device::pfc_pacr2_r), FUNC(sh1_device::pfc_pacr2_w));
	map(0x05ffffcc, 0x05ffffcd).rw(FUNC(sh1_device::pfc_pbcr1_r), FUNC(sh1_device::pfc_pbcr1_w));
	map(0x05ffffce, 0x05ffffcf).rw(FUNC(sh1_device::pfc_pbcr2_r), FUNC(sh1_device::pfc_pbcr2_w));

	map(0x05fffff0, 0x05fffff0).rw(FUNC(sh1_device::tpc_tpmr_r), FUNC(sh1_device::tpc_tpmr_w));
	map(0x05fffff1, 0x05fffff1).rw(FUNC(sh1_device::tpc_tpcr_r), FUNC(sh1_device::tpc_tpcr_w));
	map(0x05fffff2, 0x05fffff2).rw(FUNC(sh1_device::tpc_ndera_r), FUNC(sh1_device::tpc_ndera_w));
	map(0x05fffff3, 0x05fffff3).rw(FUNC(sh1_device::tpc_nderb_r), FUNC(sh1_device::tpc_nderb_w));
	map(0x05fffff4, 0x05fffff4).rw(FUNC(sh1_device::tpc_ndrb_r), FUNC(sh1_device::tpc_ndrb_w));
	map(0x05fffff5, 0x05fffff5).rw(FUNC(sh1_device::tpc_ndra_r), FUNC(sh1_device::tpc_ndra_w));
	map(0x05fffff6, 0x05fffff6).rw(FUNC(sh1_device::tpc_ndrb_alt_r), FUNC(sh1_device::tpc_ndrb_alt_w));
	map(0x05fffff7, 0x05fffff7).rw(FUNC(sh1_device::tpc_ndra_alt_r), FUNC(sh1_device::tpc_ndra_alt_w));

}

sh1_device::sh1_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock,
		int cpu_type, address_map_constructor internal_map, int addrlines, uint32_t address_mask)
...
void sh1_device::device_start()
{
	sh2_device::device_start();

	m_itu.timer[0].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_timer_callback<0>), this));
	m_itu.timer[1].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_timer_callback<1>), this));
	m_itu.timer[2].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_timer_callback<2>), this));
	m_itu.timer[3].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_timer_callback<3>), this));
	m_itu.timer[4].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_timer_callback<4>), this));
	...
	m_sci[0].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_sci_callback<0>), this));
	m_sci[1].et = machine().scheduler().timer_alloc(timer_expired_delegate(FUNC(sh1_device::sh1_sci_callback<1>), this));
	...
	std::fill(std::begin(m_irq_pin_state), std::end(m_irq_pin_state), 0);
	std::fill(std::begin(m_irq_request), std::end(m_irq_request), false);
	save_item(NAME(m_irq_pin_state));
...
uint8_t sh1_device::read_byte(offs_t offset)
{
...
uint16_t sh1_device::read_word(offs_t offset)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
uint32_t sh1_device::read_long(offs_t offset)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
uint16_t sh1_device::decrypted_read_word(offs_t offset)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
void sh1_device::write_byte(offs_t offset, uint8_t data)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
void sh1_device::write_word(offs_t offset, uint16_t data)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
void sh1_device::write_long(offs_t offset, uint32_t data)
{
	const uint32_t area = (offset >> 24) & 7;
	if (area == 6)
		m_sh2_state->icount -= ((m_bsc.wcr3 >> 11) & 3) + 1; // Consume cycles specified by A6LW
...
void sh1_device::recalc_irq()
{
	...
	// DMA transfer end IRQs: DMAC0 and DMAC1 share the top nibble of IPRC
	// (SH-1 hardware manual; Ymir's SH-1 INTC has the same assignment).
	for (uint32_t i = 0; i < 2; ++i)
	{
		if (!m_dma[i].dei)
			continue;

		int const level = (m_iprc >> 12) & 0xf;
		if (level == 0)
			continue;

		irq = level;
		vector = 72 + i * 2; // DEI0 = 72, DEI1 = 74
		break;
	}
...
// External interrupt pins.  IPRA holds IRQ0-3 and IPRB IRQ4-7, one four-bit
// level per pin (SH-1 hardware manual; the LLE Saturn CD block firmware
// programs IRQ6 to level 6 before it unmasks the host command interrupt).
// ICR bit n selects pin n's sense mode: 0 = level input, 1 = falling edge.
int sh1_device::irq_level(int irq) const
{
	switch (irq)
	{
	case 0: return (m_ipra >> 12) & 0xf;
	case 1: return (m_ipra >> 8) & 0xf;
	case 2: return (m_ipra >> 4) & 0xf;
	case 3: return m_ipra & 0xf;
	case 4: return (m_iprb >> 12) & 0xf;
	case 5: return (m_iprb >> 8) & 0xf;
	case 6: return (m_iprb >> 4) & 0xf;
	case 7: return m_iprb & 0xf;
	}
	return 0;
}
...
void sh1_device::execute_set_input(int inputnum, int state)
{
	...
	int8_t const previous = m_irq_pin_state[inputnum];
	m_irq_pin_state[inputnum] = level ? 1 : 0;

	bool const edge = BIT(m_icr, inputnum);
	bool const request = edge ? (level && !previous) : level; // edge latches, level holds
	m_irq_request[inputnum] = request;

	if (request && irq_level(inputnum) != 0)
	{
		m_sh2_state->pending_irq |= 1 << inputnum;
		m_test_irq = 1;
	}
	else if (!request)
	{
...
// SH-1 exception entry.  Unlike the SH-2 the SH-1 has one vector per external
// pin (64 + pin number) and compares the pin's IPR level against the SR mask.
void sh1_device::sh2_exception(const char *message, int irqline)
{
	int vector, level;

	if (irqline == 16)
	{
		// NMI: always accepted, vector 11
		vector = 11;
		level = 16;
	}
	else if (irqline == m_sh2_state->internal_irq_level)
	{
		// on-chip peripheral request: the priority is the level, the vector
		// was chosen when the source raised the request
		vector = m_internal_irq_vector;
		level = irqline;
		m_sh2_state->internal_irq_level = -1;
	}
	else if (irqline >= IRQ0 && irqline <= IRQ7)
	{
		level = irq_level(irqline);
		vector = 64 + irqline;
		if (level == 0)
			return;
	}
	...
	{
		sh2_device::sh2_exception(message, irqline);
		return;
	}

	if (level <= ((m_sh2_state->sr >> 4) & 15))
		return;

	sh2_exception_internal(message, level, vector);
}


// Interrupt Controller (INTC)

uint16_t sh1_device::intc_ipra_r()
{
...
void sh1_device::intc_ipra_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::intc_iprb_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::intc_iprc_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_INTC_WR, "%s: intc_iprc_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_iprc);
}

uint16_t sh1_device::intc_iprd_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::intc_iprd_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_INTC_WR, "%s: intc_iprd_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_iprd);
}

uint16_t sh1_device::intc_ipre_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::intc_ipre_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_INTC_WR, "%s: intc_ipre_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_ipre);
}

uint16_t sh1_device::intc_icr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::intc_icr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh1_device::ubc_barh_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::ubc_barh_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_UBC_WR, "%s: Break Address Register H, ubc_barh_w = %04x\n", machine().describe_context(), data);
	COMBINE_DATA(&m_ubc.barh);
}

uint16_t sh1_device::ubc_barl_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::ubc_barl_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_UBC_WR, "%s: Break Address Register L, ubc_barl_w = %04x\n", machine().describe_context(), data);
	COMBINE_DATA(&m_ubc.barl);
}

uint16_t sh1_device::ubc_bamrh_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::ubc_bamrh_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_UBC_WR, "%s: Break Address Mask Register H, ubc_bmarh_w = %04x\n", machine().describe_context(), data);
	COMBINE_DATA(&m_ubc.bamrh);
}

uint16_t sh1_device::ubc_bamrl_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::ubc_bamrl_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_UBC_WR, "%s: Break Address Mask Register L, ubc_bmarl_w = %04x\n", machine().describe_context(), data);
	COMBINE_DATA(&m_ubc.bamrl);
}

uint16_t sh1_device::ubc_bbr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::ubc_bbr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::bsc_bcr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh1_device::bsc_wcr1_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_wcr1_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_BSC_WR, "%s: Wait State Control Register 1, bsc_wcr1_w = %04x\n", machine().describe_context(), data);
	COMBINE_DATA(&m_bsc.wcr1);
}

uint16_t sh1_device::bsc_wcr2_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_wcr2_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_BSC_WR, "%s: Wait State Control Register 2, bsc_wcr2_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_bsc.wcr2);
}

uint16_t sh1_device::bsc_wcr3_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_wcr3_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_BSC_WR, "%s: Wait State Control Register 3, bsc_wcr3_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_bsc.wcr3);
}

uint16_t sh1_device::bsc_dcr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_dcr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::bsc_pcr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::bsc_rcr_w(uint16_t data)
{
	if ((data >> 8) != 0x5a)
		return;
...
uint16_t sh1_device::bsc_rtcsr_r()
{
	if (!machine().side_effects_disabled())
	{
...
void sh1_device::bsc_rtcsr_w(uint16_t data)
{
	if ((data >> 8) != 0xa5)
		return;
...
uint16_t sh1_device::bsc_rtcnt_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_rtcnt_w(uint16_t data)
{
	if ((data >> 8) != 0x69)
		return;
...
uint16_t sh1_device::bsc_rtcor_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::bsc_rtcor_w(uint16_t data)
{
	if ((data >> 8) != 0x96)
		return;
...
template uint32_t sh1_device::dma_sar_r<0>();
template uint32_t sh1_device::dma_sar_r<1>();
template uint32_t sh1_device::dma_sar_r<2>();
template uint32_t sh1_device::dma_sar_r<3>();

template <int Channel>
uint32_t sh1_device::dma_sar_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::dma_sar_w<0>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_sar_w<1>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_sar_w<2>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_sar_w<3>(offs_t offset, uint32_t data, uint32_t mem_mask);

template <int Channel>
void sh1_device::dma_sar_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
template uint32_t sh1_device::dma_dar_r<0>();
template uint32_t sh1_device::dma_dar_r<1>();
template uint32_t sh1_device::dma_dar_r<2>();
template uint32_t sh1_device::dma_dar_r<3>();

template <int Channel>
uint32_t sh1_device::dma_dar_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::dma_dar_w<0>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_dar_w<1>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_dar_w<2>(offs_t offset, uint32_t data, uint32_t mem_mask);
template void sh1_device::dma_dar_w<3>(offs_t offset, uint32_t data, uint32_t mem_mask);

template <int Channel>
void sh1_device::dma_dar_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	LOGMASKED(LOG_DMA_WR, "%s: DMA Destination Address Register %d, dma_dar_w = %08x & %08x\n", machine().describe_context(), Channel, data, mem_mask);
	COMBINE_DATA(&m_dma[Channel].dar);
}

template uint16_t sh1_device::dma_tcr_r<0>();
template uint16_t sh1_device::dma_tcr_r<1>();
template uint16_t sh1_device::dma_tcr_r<2>();
template uint16_t sh1_device::dma_tcr_r<3>();

template <int Channel>
uint16_t sh1_device::dma_tcr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::dma_tcr_w<0>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_tcr_w<1>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_tcr_w<2>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_tcr_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::dma_tcr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
template uint16_t sh1_device::dma_chcr_r<0>();
template uint16_t sh1_device::dma_chcr_r<1>();
template uint16_t sh1_device::dma_chcr_r<2>();
template uint16_t sh1_device::dma_chcr_r<3>();

template <int Channel>
uint16_t sh1_device::dma_chcr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::dma_chcr_w<0>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_chcr_w<1>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_chcr_w<2>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::dma_chcr_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::dma_chcr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::dmaor_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::execute_dma(int ch)
{
...
void sh1_device::execute_peripherals(int peripheral_cycles)
{
	m_dma_cycles += peripheral_cycles;

	// Externally requested transfers (CHCR resource select of the /DREQ pin)
	// advance one unit per active request instead of running as a burst.
	for (int ch = 0; ch < 2; ++ch)
		step_external_dma(ch);
}

void sh1_device::set_dreq_input(int channel, int state)
{
	if (channel < 0 || channel > 1)
		return;

	m_dreq[channel] = (state != 0);
	if (m_dreq[channel])
		step_external_dma(channel);
}

// Resource select 0 selects the external /DREQ pin on channel 0 and value 1
// does on channel 1 (SH-1 hardware manual, CHCR RS field).
bool sh1_device::external_dma_selected(int ch) const
{
	uint8_t const rs = (m_dma[ch].chcr >> 10) & 3;
	bool const external = (rs == 0) || (rs == 1 && ch == 1);
	return external && (m_dma[ch].chcr & 1) && (m_dmaor & 1) && !(m_dma[ch].chcr & 2);
}

void sh1_device::step_external_dma(int ch)
{
	if (ch < 0 || ch > 1 || !m_dreq[ch] || !external_dma_selected(ch))
		return;

	bool const ts = (m_dma[ch].chcr & 8); // transfer size: word when set
	uint32_t const sar = m_dma[ch].sar;
	uint32_t const dar = m_dma[ch].dar;

	if (ts)
		m_program->write_word(dar & m_am, m_program->read_word(sar & m_am));
	else
		m_program->write_byte(dar & m_am, m_program->read_byte(sar & m_am));

	// address modes: 0 = fixed, 1 = increment, 2 = decrement
	static const int dma_word_size[4] = { 0, +1, -1, 0 };
	int const unit = ts ? 2 : 1;
	uint8_t const sm = (m_dma[ch].chcr >> 12) & 3;
	uint8_t const dm = (m_dma[ch].chcr >> 14) & 3;
	m_dma[ch].sar = sar + dma_word_size[sm] * unit;
	m_dma[ch].dar = dar + dma_word_size[dm] * unit;
	...
	if (m_dma[ch].tcr == 0)
	{
		// Transfer end: TE and, when the channel's interrupt is enabled, the
		// DEI request.  The firmware's transfer loops poll TCR/CHCR, so both
		// the flag and the interrupt have to appear.
		m_dma[ch].chcr |= 2;
		m_dma[ch].dei = true;
		recalc_irq();
	}
...
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback<0>);
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback<1>);
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback<2>);
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback<3>);
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback<4>);

template<int Which>
TIMER_CALLBACK_MEMBER(sh1_device::sh1_timer_callback)
{
...
void sh1_device::start_timer(int i)
{
...
void sh1_device::itu_tstr_w(uint8_t data)
{
...
void sh1_device::itu_tsnc_w(uint8_t data)
{
	LOGMASKED(LOG_ITU_WR, "%s: Timer Synchro Register, itu_tsnc_w = %02x\n", machine().describe_context(), data);
	m_itu.tsnc = data;
}

uint8_t sh1_device::itu_tmdr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::itu_tmdr_w(uint8_t data)
{
...
void sh1_device::itu_tfcr_w(uint8_t data)
{
...
void sh1_device::itu_tocr_w(uint8_t data)
{
...
template uint8_t sh1_device::itu_tcr_r<0>();
template uint8_t sh1_device::itu_tcr_r<1>();
template uint8_t sh1_device::itu_tcr_r<2>();
template uint8_t sh1_device::itu_tcr_r<3>();
template uint8_t sh1_device::itu_tcr_r<4>();

template <int Channel>
uint8_t sh1_device::itu_tcr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_tcr_w<0>(uint8_t data);
template void sh1_device::itu_tcr_w<1>(uint8_t data);
template void sh1_device::itu_tcr_w<2>(uint8_t data);
template void sh1_device::itu_tcr_w<3>(uint8_t data);
template void sh1_device::itu_tcr_w<4>(uint8_t data);

template <int Channel>
void sh1_device::itu_tcr_w(uint8_t data)
{
...
template uint8_t sh1_device::itu_tior_r<0>();
template uint8_t sh1_device::itu_tior_r<1>();
template uint8_t sh1_device::itu_tior_r<2>();
template uint8_t sh1_device::itu_tior_r<3>();
template uint8_t sh1_device::itu_tior_r<4>();

template <int Channel>
uint8_t sh1_device::itu_tior_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_tior_w<0>(uint8_t data);
template void sh1_device::itu_tior_w<1>(uint8_t data);
template void sh1_device::itu_tior_w<2>(uint8_t data);
template void sh1_device::itu_tior_w<3>(uint8_t data);
template void sh1_device::itu_tior_w<4>(uint8_t data);

template <int Channel>
void sh1_device::itu_tior_w(uint8_t data)
{
...
template uint8_t sh1_device::itu_tier_r<0>();
template uint8_t sh1_device::itu_tier_r<1>();
template uint8_t sh1_device::itu_tier_r<2>();
template uint8_t sh1_device::itu_tier_r<3>();
template uint8_t sh1_device::itu_tier_r<4>();

template <int Channel>
uint8_t sh1_device::itu_tier_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_tier_w<0>(uint8_t data);
template void sh1_device::itu_tier_w<1>(uint8_t data);
template void sh1_device::itu_tier_w<2>(uint8_t data);
template void sh1_device::itu_tier_w<3>(uint8_t data);
template void sh1_device::itu_tier_w<4>(uint8_t data);

template <int Channel>
void sh1_device::itu_tier_w(uint8_t data)
{
...
template uint8_t sh1_device::itu_tsr_r<0>();
template uint8_t sh1_device::itu_tsr_r<1>();
template uint8_t sh1_device::itu_tsr_r<2>();
template uint8_t sh1_device::itu_tsr_r<3>();
template uint8_t sh1_device::itu_tsr_r<4>();

template <int Channel>
uint8_t sh1_device::itu_tsr_r()
{
	if (!machine().side_effects_disabled())
	{
...
template void sh1_device::itu_tsr_w<0>(uint8_t data);
template void sh1_device::itu_tsr_w<1>(uint8_t data);
template void sh1_device::itu_tsr_w<2>(uint8_t data);
template void sh1_device::itu_tsr_w<3>(uint8_t data);
template void sh1_device::itu_tsr_w<4>(uint8_t data);

template <int Channel>
void sh1_device::itu_tsr_w(uint8_t data)
{
...
template uint16_t sh1_device::itu_tcnt_r<0>();
template uint16_t sh1_device::itu_tcnt_r<1>();
template uint16_t sh1_device::itu_tcnt_r<2>();
template uint16_t sh1_device::itu_tcnt_r<3>();
template uint16_t sh1_device::itu_tcnt_r<4>();

template <int Channel>
uint16_t sh1_device::itu_tcnt_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_tcnt_w<0>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_tcnt_w<1>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_tcnt_w<2>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_tcnt_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_tcnt_w<4>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::itu_tcnt_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_ITU_WR, "%s: Timer Counter %d, itu_tcnt_w = %04x & %04x\n", machine().describe_context(), Channel, data, mem_mask);
	COMBINE_DATA(&m_itu.timer[Channel].tcnt);
}

template uint16_t sh1_device::itu_gra_r<0>();
template uint16_t sh1_device::itu_gra_r<1>();
template uint16_t sh1_device::itu_gra_r<2>();
template uint16_t sh1_device::itu_gra_r<3>();
template uint16_t sh1_device::itu_gra_r<4>();

template <int Channel>
uint16_t sh1_device::itu_gra_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_gra_w<0>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_gra_w<1>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_gra_w<2>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_gra_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_gra_w<4>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::itu_gra_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_ITU_WR, "%s: General Register A %d, itu_gra_w = %04x\n", machine().describe_context(), Channel, data);
	COMBINE_DATA(&m_itu.timer[Channel].gra);
}

template uint16_t sh1_device::itu_grb_r<0>();
template uint16_t sh1_device::itu_grb_r<1>();
template uint16_t sh1_device::itu_grb_r<2>();
template uint16_t sh1_device::itu_grb_r<3>();
template uint16_t sh1_device::itu_grb_r<4>();

template <int Channel>
uint16_t sh1_device::itu_grb_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_grb_w<0>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_grb_w<1>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_grb_w<2>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_grb_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_grb_w<4>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::itu_grb_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_ITU_WR, "%s: General Register B %d, itu_grb_w = %04x\n", machine().describe_context(), Channel, data);
	COMBINE_DATA(&m_itu.timer[Channel].grb);
}

template uint16_t sh1_device::itu_bra_r<3>();
template uint16_t sh1_device::itu_bra_r<4>();

template <int Channel>
uint16_t sh1_device::itu_bra_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_bra_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_bra_w<4>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::itu_bra_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_ITU_WR, "%s: Buffer Register A %d, itu_bra_w = %04x\n", machine().describe_context(), Channel, data);
	COMBINE_DATA(&m_itu.timer[Channel].bra);
}

template uint16_t sh1_device::itu_brb_r<3>();
template uint16_t sh1_device::itu_brb_r<4>();

template <int Channel>
uint16_t sh1_device::itu_brb_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::itu_brb_w<3>(offs_t offset, uint16_t data, uint16_t mem_mask);
template void sh1_device::itu_brb_w<4>(offs_t offset, uint16_t data, uint16_t mem_mask);

template <int Channel>
void sh1_device::itu_brb_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::tpc_tpmr_w(uint8_t data)
{
...
void sh1_device::tpc_tpcr_w(uint8_t data)
{
...
uint8_t sh1_device::tpc_ndera_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::tpc_ndra_w(uint8_t data)
{
	LOGMASKED(LOG_TPC_WR, "%s: Next Data Register A, tpc_ndra_w = %02x\n", machine().describe_context(), data);
}

uint8_t sh1_device::tpc_ndra_alt_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::tpc_ndrb_w(uint8_t data)
{
	LOGMASKED(LOG_TPC_WR, "%s: Next Data Register B, tpc_ndrb_w = %02x\n", machine().describe_context(), data);
}

uint8_t sh1_device::tpc_ndrb_alt_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::tpc_ndrb_alt_w(uint8_t data)
{
...
uint8_t sh1_device::wdt_tcsr_r()
{
	return m_wdt.tcsr;
}

void sh1_device::wdt_tcsr_w(uint8_t data)
{
	m_wdt.tcsr = data;
}

uint8_t sh1_device::wdt_tcnt_r()
{
	return 0;
}

void sh1_device::wdt_tcnt_w(uint8_t data)
{
}

uint8_t sh1_device::wdt_rstcsr_r()
{
	return 0;
}

void sh1_device::wdt_rstcsr_w(uint8_t data)
{
...
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_sci_callback<0>);
template TIMER_CALLBACK_MEMBER(sh1_device::sh1_sci_callback<1>);

template<int Which>
TIMER_CALLBACK_MEMBER(sh1_device::sh1_sci_callback)
{
...
template uint8_t sh1_device::sci_smr_r<0>();
template uint8_t sh1_device::sci_smr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_smr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::sci_smr_w<0>(uint8_t data);
template void sh1_device::sci_smr_w<1>(uint8_t data);

template <int Channel>
void sh1_device::sci_smr_w(uint8_t data)
{
...
template uint8_t sh1_device::sci_brr_r<0>();
template uint8_t sh1_device::sci_brr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_brr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::sci_brr_w<0>(uint8_t data);
template void sh1_device::sci_brr_w<1>(uint8_t data);

template <int Channel>
void sh1_device::sci_brr_w(uint8_t data)
{
	LOGMASKED(LOG_SCI_WR, "%s: Bit Rate Register %d, sci_brr_w = %02x\n", machine().describe_context(), Channel, data);
	m_sci[Channel].brr = data;
}

template uint8_t sh1_device::sci_scr_r<0>();
template uint8_t sh1_device::sci_scr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_scr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::sci_scr_w<0>(uint8_t data);
template void sh1_device::sci_scr_w<1>(uint8_t data);

template <int Channel>
void sh1_device::sci_scr_w(uint8_t data)
{
...
template uint8_t sh1_device::sci_tdr_r<0>();
template uint8_t sh1_device::sci_tdr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_tdr_r()
{
	if (!machine().side_effects_disabled())
...
template void sh1_device::sci_tdr_w<0>(uint8_t data);
template void sh1_device::sci_tdr_w<1>(uint8_t data);

template <int Channel>
void sh1_device::sci_tdr_w(uint8_t data)
{
	LOGMASKED(LOG_SCI_WR, "%s: Transmit Data Register %d, sci_tdr_w = %02x\n", machine().describe_context(), Channel, data);
	m_sci[Channel].tdr = data;
}

template uint8_t sh1_device::sci_ssr_r<0>();
template uint8_t sh1_device::sci_ssr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_ssr_r()
{
	if (!machine().side_effects_disabled())
	{
...
template void sh1_device::sci_ssr_w<0>(uint8_t data);
template void sh1_device::sci_ssr_w<1>(uint8_t data);

template <int Channel>
void sh1_device::sci_ssr_w(uint8_t data)
{
...
template uint8_t sh1_device::sci_rdr_r<0>();
template uint8_t sh1_device::sci_rdr_r<1>();

template <int Channel>
uint8_t sh1_device::sci_rdr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::write_padr(uint16_t data)
{
	LOGMASKED(LOG_PFC_WR, "%s: Port A Input write: write_padr: %04x\n", machine().describe_context(), data);
	m_pfc.padr_in = data;
}

void sh1_device::write_pbdr(uint16_t data)
{
	LOGMASKED(LOG_PFC_WR, "%s: Port B Input write: write_pbdr: %04x\n", machine().describe_context(), data);
	m_pfc.pbdr_in = data;
}

template void sh1_device::write_padr_bit< 0>(int state);
template void sh1_device::write_padr_bit< 1>(int state);
template void sh1_device::write_padr_bit< 2>(int state);
template void sh1_device::write_padr_bit< 3>(int state);
template void sh1_device::write_padr_bit< 4>(int state);
template void sh1_device::write_padr_bit< 5>(int state);
template void sh1_device::write_padr_bit< 6>(int state);
template void sh1_device::write_padr_bit< 7>(int state);
template void sh1_device::write_padr_bit< 8>(int state);
template void sh1_device::write_padr_bit< 9>(int state);
template void sh1_device::write_padr_bit<10>(int state);
template void sh1_device::write_padr_bit<11>(int state);
template void sh1_device::write_padr_bit<12>(int state);
template void sh1_device::write_padr_bit<13>(int state);
template void sh1_device::write_padr_bit<14>(int state);
template void sh1_device::write_padr_bit<15>(int state);

template <int Line>
void sh1_device::write_padr_bit(int state)
{
...
template void sh1_device::write_pbdr_bit< 0>(int state);
template void sh1_device::write_pbdr_bit< 1>(int state);
template void sh1_device::write_pbdr_bit< 2>(int state);
template void sh1_device::write_pbdr_bit< 3>(int state);
template void sh1_device::write_pbdr_bit< 4>(int state);
template void sh1_device::write_pbdr_bit< 5>(int state);
template void sh1_device::write_pbdr_bit< 6>(int state);
template void sh1_device::write_pbdr_bit< 7>(int state);
template void sh1_device::write_pbdr_bit< 8>(int state);
template void sh1_device::write_pbdr_bit< 9>(int state);
template void sh1_device::write_pbdr_bit<10>(int state);
template void sh1_device::write_pbdr_bit<11>(int state);
template void sh1_device::write_pbdr_bit<12>(int state);
template void sh1_device::write_pbdr_bit<13>(int state);
template void sh1_device::write_pbdr_bit<14>(int state);
template void sh1_device::write_pbdr_bit<15>(int state);

template <int Line>
void sh1_device::write_pbdr_bit(int state)
{
	LOGMASKED(LOG_PFC_WR, "%s: Port B Bit %d Input write: write_pbdr_bit: %d\n", machine().describe_context(), Line, state);
	m_pfc.pbdr_in = (m_pfc.pbdr_in & ~(1 << Line)) | (state << Line);
}

uint16_t sh1_device::pfc_paior_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::pfc_paior_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_PFC_WR, "%s: Port A I/O (Direction) Register, pfc_paior_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_pfc.paior);
}

uint16_t sh1_device::pfc_pacr1_r()
{
...
void sh1_device::pfc_pacr1_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	static constexpr uint16_t PACR1_W_MASK = 0xfffd;
...
uint16_t sh1_device::pfc_pacr2_r()
{
...
void sh1_device::pfc_pacr2_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	static constexpr uint16_t PACR2_W_MASK = 0x55ff;
...
uint16_t sh1_device::pfc_pbior_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::pfc_pbior_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	LOGMASKED(LOG_PFC_WR, "%s: Port B I/O (Direction) Register, pfc_pbior_w = %04x & %04x\n", machine().describe_context(), data, mem_mask);
	COMBINE_DATA(&m_pfc.pbior);
}

uint16_t sh1_device::pfc_pbcr1_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::pfc_pbcr1_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh1_device::pfc_pbcr2_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::pfc_pbcr2_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh1_device::pfc_padr_r()
{
...
void sh1_device::pfc_padr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sh1_device::pfc_pbdr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh1_device::pfc_cascr_r()
{
	if (!machine().side_effects_disabled())
...
void sh1_device::pfc_cascr_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
