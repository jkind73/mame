...
selected={'m_file_info_invalidated','m_file_scope_start','m_file_info_words','m_saved_dir_count','numfiles','firstfile','finfbuf','m_host_transfer_active','xfertype','xfertype32','xfercount','xferdnum','cr1','cr2','cr3','cr4','hirqreg','cd_stat','playtype','cdda_repeat_count'}
