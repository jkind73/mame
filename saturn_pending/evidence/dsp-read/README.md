...
New-source native positives passed: 4,096 read-DMA programs on
...
`local/regressions.log`. Native build 35341486010 and the complete expanded consumer passed; see
`../ca63041f-live/` for source/binary identities and runtime logs.
