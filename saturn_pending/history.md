...
Superseded checkpoint narrative, preserved for audit. Use README.md and the
source-labelled evidence directories for current status. Old pending/blocked
statements below are historical, not current acceptance claims.
