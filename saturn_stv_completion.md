...
- [ ] **DSP-01 — Resolve instruction/flag/control semantics. [P/V/R]**
  ...
  - RX writes through D1/MVI now refresh the cached multiplier at the existing instruction boundary (native WIP). Qualified ea9a7a7c passes24 controls/fails40 new-product programs; all64 old-P observations pass. Corrected actual fetch/ALU/MVI/bus methods pass34,816 UBSan cases; full-TU syntax and parser controls pass. New native gate adds256 multiplier programs/four configurations. Reference/contract: `saturn_pending/evidence/dsp-multiplier/README.md`. Exact multiply timing and broader parallel-bus semantics remain open.
