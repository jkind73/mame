...
from test_scudsp_pram_runtime import validate_output
rows=[f'DSP_PRAM case={i} PASS\n' for i in range(1,33)]
final='DSP_PRAM PASS cases=32\n'
...
print('12 DSP program RAM result-parser controls passed (no emulator execution)')
