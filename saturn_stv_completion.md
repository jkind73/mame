...
- [ ] **DSP-03 — Qualify execution timing and integration. [P/V]**
  ...
  - IMPL-0149 separates EX/END execution stopping from device reset and preserves pending slots/DMA across an EX-only stop/restart (implementation candidate, syntax checked only). Reset now clears the stored host controls and holds execution through the DSP-owned stop gate; ES and ordinary prefetch remain unimplemented.
