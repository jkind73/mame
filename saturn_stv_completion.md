...
- [ ] **DSP-01 — Resolve instruction/flag/control semantics. [P/V/R]**
  ...
  - The documented12-bit LOP input width is now enforced at the shared destination setter (native WIP). Actual methods pass991,232 width/conditional/full-countdown cases under UBSan. Qualified25f13c07 passes42 controls/fails38 real BTM/LPS counts, and active file replay reproduces65536 rather than4096 iterations. New gate adds320 programs/four configurations plus active-loop replay. Contract: `saturn_pending/evidence/dsp-lop/README.md`; looped-instruction writes and exact timing remain open.
