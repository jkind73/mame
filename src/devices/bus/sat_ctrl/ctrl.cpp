...
DEFINE_DEVICE_TYPE(SATURN_CONTROL_PORT, saturn_control_port_device,
                   "saturn_control_port", "Sega Saturn controller port")
...
device_saturn_control_port_interface::device_saturn_control_port_interface(
    const machine_config &mconfig, device_t &device)
